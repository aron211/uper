...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("25ab9bf3", content, true, context)
};
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("7f089f64", content, true, context)
};
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("f151c06a", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_VideoBanner_vue_vue_type_style_index_0_id_132ea39a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(236);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_VideoBanner_vue_vue_type_style_index_0_id_132ea39a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_VideoBanner_vue_vue_type_style_index_0_id_132ea39a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_VideoBanner_vue_vue_type_style_index_0_id_132ea39a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_VideoBanner_vue_vue_type_style_index_0_id_132ea39a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".use-text-title[data-v-132ea39a]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-132ea39a]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-132ea39a]{font-size:28px;line-height:44px}}.use-text-title2[data-v-132ea39a]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-132ea39a]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-132ea39a]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-132ea39a]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-132ea39a]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-132ea39a]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-132ea39a]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-132ea39a]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-132ea39a]{font-size:16px;line-height:24px}}.use-text-caption[data-v-132ea39a],.use-text-paragraph[data-v-132ea39a]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-132ea39a]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-132ea39a]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-132ea39a]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-132ea39a]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-132ea39a]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-132ea39a]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-132ea39a]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-132ea39a]{display:none}}.hero-content[data-v-132ea39a]{position:relative}.hero-content>.container[data-v-132ea39a]{padding-left:0!important;padding-right:0!important;margin:0 auto}@media(min-width:1280px){.hero-content[data-v-132ea39a]{margin-bottom:0}[dir=ltr] .hero-content[data-v-132ea39a]{padding-left:48px}[dir=rtl] .hero-content[data-v-132ea39a]{padding-right:48px}}@media(max-width:959px){.hero-content[data-v-132ea39a]{margin-bottom:0;padding-bottom:8px}}.banner-text[data-v-132ea39a]{position:relative;z-index:4;padding:32px 0}@media(min-width:960px){.banner-text[data-v-132ea39a]{margin-top:-10vh}}@media(max-width:1279px){.banner-text[data-v-132ea39a]{padding:16px 0}}@media(max-width:959px){.banner-text[data-v-132ea39a]{margin-top:58vh!important;height:30vh;max-width:100%;margin:0 auto;text-align:left;color:#252b42}}.title[data-v-132ea39a]{margin-bottom:24px}@media(max-width:1279px){.title[data-v-132ea39a]{height:20vh}}@media(max-width:1279px){.titleMovil[data-v-132ea39a]{font-family:\"Poppins\",sans-serif!important;font-weight:600;font-size:calc(2.038em + .9vw);line-height:1}}.text-helper[data-v-132ea39a]{display:inline-block;margin-top:.3em}@media(min-width:1280px){[dir=ltr] .text-helper[data-v-132ea39a]{padding-right:80px}[dir=rtl] .text-helper[data-v-132ea39a]{padding-left:80px}}.second-row[data-v-132ea39a]{display:flex;align-items:center}.subtitle[data-v-132ea39a]{margin-bottom:24px}@media(min-width:1280px){[dir=ltr] .subtitle[data-v-132ea39a]{padding-right:8px}[dir=rtl] .subtitle[data-v-132ea39a]{padding-left:8px}}@media(max-width:1279px){.subtitle[data-v-132ea39a]{margin-top:5.5vh;font-family:\"Poppins\",sans-serif!important;margin-bottom:8px;font-size:calc(.8em + .9vw)}}.consultas[data-v-132ea39a]{display:flex;justify-content:center}.consultas .btnconsultas[data-v-132ea39a]{margin-top:1vh;font-family:\"Poppins\",sans-serif!important;font-size:calc(.5em + .5vw);text-transform:capitalize}[dir=ltr] .icon[data-v-132ea39a]{margin-left:8px}[dir=rtl] .icon[data-v-132ea39a]{margin-right:8px}.v-application--is-rtl .icon[data-v-132ea39a]{transform:rotate(180deg);-webkit-transform:rotate(180deg);-moz-transform:rotate(180deg);-ms-transform:rotate(180deg);-o-transform:rotate(180deg)}.mobile-cover[data-v-132ea39a]{position:relative;top:32px;left:0;margin:0;height:0;background:#000}.mobile-cover img[data-v-132ea39a]{min-width:100%;height:100%;opacity:.9}@media(max-width:599px){.mobile-cover img[data-v-132ea39a]{margin-bottom:100px;-o-object-fit:contain;object-fit:contain;opacity:.9;width:100vw;height:60vh}}.visual-content[data-v-132ea39a]{position:relative}@media(min-width:960px){.deco-banner[data-v-132ea39a]{opacity:.9}}.deco-banner .menu-bg[data-v-132ea39a]{top:-670px;right:-50px}@media(max-width:959px){.deco-banner .menu-bg[data-v-132ea39a]{top:-750px;background-image:url(https://via.placeholder.com/964x723/1071ef/FFFFF);background-repeat:no-repeat;background-size:cover;background-position:top;overflow:hidden}.deco-banner .menu-bg[data-v-132ea39a]:after{content:\"\";position:absolute;background:rgba(0,0,0,.6);width:100%;height:100%}}.deco-banner .video-bg[data-v-132ea39a]{top:-280px;opacity:.45}@media(max-width:959px){.deco-banner .video-bg[data-v-132ea39a]{display:none}}.parallax-banner[data-v-132ea39a]{position:absolute;top:100px;width:300px;height:400px;z-index:10;transform:scale(.4);transform-origin:top left}[dir=ltr] .parallax-banner[data-v-132ea39a]{left:-40px}[dir=rtl] .parallax-banner[data-v-132ea39a]{right:-40px}.parallax-banner>div[data-v-132ea39a]{top:0}.parallax-banner>div[data-v-132ea39a]  svg{opacity:.4;width:600px;height:600px}.video-wrap[data-v-132ea39a]{position:relative;width:100vw;height:90vh;margin-top:64px}@media(max-width:959px){.video-wrap[data-v-132ea39a]{display:none}}.video-figure[data-v-132ea39a]{height:50vh}.inner-figure[data-v-132ea39a],.video-figure[data-v-132ea39a]{position:absolute;width:100vw}.inner-figure[data-v-132ea39a]{height:90vh}.juntadir[data-v-132ea39a]{display:block;margin-left:-10vw;margin-top:5vh;position:absolute;top:0!important;left:0!important;width:100vw!important;height:90vh!important;z-index:2!important}.search-banner[data-v-132ea39a]{margin-top:24px;font-size:18px;overflow:visible}.search-banner.v-card[data-v-132ea39a]:not(.v-sheet--tile):not(.v-card--shaped){border-radius:75px}@media(min-width:960px){.search-banner[data-v-132ea39a]{width:700px;max-width:none}}@media(max-width:599px){.search-banner[data-v-132ea39a]{margin-top:32px}}.search-banner[data-v-132ea39a]  .v-text-field--filled>.v-input__control>.v-input__slot{background:none!important;min-height:0;padding:0!important}.search-banner[data-v-132ea39a]  .v-text-field--filled>.v-input__control>.v-input__slot .v-input__append-inner{margin-top:4px}.search-banner[data-v-132ea39a]  .v-text-field--filled>.v-input__control>.v-input__slot:after,.search-banner[data-v-132ea39a]  .v-text-field--filled>.v-input__control>.v-input__slot:before{display:none}.search-banner .v-text-field--full-width .v-label--active[data-v-132ea39a],.search-banner[data-v-132ea39a]  .v-text-field--filled .v-label--active{transform:translateY(-18px) scale(.75);transform-origin:top left}.search[data-v-132ea39a]{font-size:18px;width:100%}[data-v-132ea39a] .search.v-text-field input{margin:0;border-radius:75px;padding:16px;max-height:none;height:75px}@media(min-width:960px){[data-v-132ea39a] .search.v-text-field input{padding:32px 240px 24px 24px}}.theme--light[data-v-132ea39a]  .search.v-text-field input:focus{box-shadow:var(--v-primarylight-base) 0 0 0 .4rem}.theme--dark[data-v-132ea39a]  .search.v-text-field input:focus{box-shadow:var(--v-primarydark-base) 0 0 0 .4rem}.search[data-v-132ea39a]  label{top:28px}[dir=ltr] .search[data-v-132ea39a]  label{left:24px!important}[dir=rtl] .search[data-v-132ea39a]  label{right:24px!important}.action[data-v-132ea39a]{position:absolute;top:0;height:100%;display:flex;align-items:center;padding:16px}[dir=ltr] .action[data-v-132ea39a]{right:0}[dir=rtl] .action[data-v-132ea39a]{left:0}.button.v-btn:not(.v-btn--round).v-size--default[data-v-132ea39a]{width:100px;height:48px;line-height:48px;align-items:center;padding:2px 28px;box-sizing:content-box}@media(max-width:599px){.button.v-btn:not(.v-btn--round).v-size--default[data-v-132ea39a]{padding:2px;width:50px;background:none!important;box-shadow:none;color:var(--v-primary-base)}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AskDoctors_vue_vue_type_style_index_0_id_9e9da334_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(242);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AskDoctors_vue_vue_type_style_index_0_id_9e9da334_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AskDoctors_vue_vue_type_style_index_0_id_9e9da334_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AskDoctors_vue_vue_type_style_index_0_id_9e9da334_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AskDoctors_vue_vue_type_style_index_0_id_9e9da334_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".use-text-title[data-v-9e9da334]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-9e9da334]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-9e9da334]{font-size:28px;line-height:44px}}.use-text-title2[data-v-9e9da334]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-9e9da334]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-9e9da334]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-9e9da334]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-9e9da334]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-9e9da334]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-9e9da334]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-9e9da334]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-9e9da334]{font-size:16px;line-height:24px}}.use-text-caption[data-v-9e9da334],.use-text-paragraph[data-v-9e9da334]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-9e9da334]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-9e9da334]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-9e9da334]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-9e9da334]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-9e9da334]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-9e9da334]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-9e9da334]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-9e9da334]{display:none}}.root[data-v-9e9da334]{position:relative;z-index:10}@media(max-width:959px){.root .nav>*[data-v-9e9da334]{display:flex;overflow:auto}}.side-filter[data-v-9e9da334]{text-align:center}.side-filter .subtitle[data-v-9e9da334]{font-size:120%}.side-filter .nav[data-v-9e9da334]{background:none}@media(max-width:599px){.side-filter .nav>*[data-v-9e9da334]{padding:0 24px}}.side-filter .filter[data-v-9e9da334]{border-radius:40px;text-transform:capitalize;margin-bottom:8px;padding:4px 16px;width:90%;min-height:36px}.side-filter .filter[data-v-9e9da334]:before{border-radius:40px}@media(min-width:600px){.side-filter .filter[data-v-9e9da334]{overflow:hidden}}@media(max-width:959px){.side-filter .filter>div[data-v-9e9da334]{text-align:center}}.side-filter[data-v-9e9da334]  .v-list-item--active{background:var(--v-primarylight-base);color:var(--v-primarydark-base)}.massonry button[data-v-9e9da334]{width:100%}@media(min-width:960px){.massonry .consulta[data-v-9e9da334]{display:flex;align-items:center;justify-content:center;width:15vw}}.title-default[data-v-9e9da334]{padding:0 16px}@media(min-width:600px){.title-default[data-v-9e9da334]{padding:0 32px}}.title-primary[data-v-9e9da334]{font-size:48px;line-height:62px;text-transform:capitalize;font-weight:700;margin-bottom:40px;position:relative}@media(max-width:1279px){.title-primary[data-v-9e9da334]{font-size:38px;line-height:50px}}@media(max-width:959px){.title-primary[data-v-9e9da334]{text-align:center;margin-bottom:32px}}@media(max-width:599px){.title-primary[data-v-9e9da334]{font-size:32px;line-height:42px}}.title-secondary[data-v-9e9da334]{color:var(--v-secondarydark-base);font-size:48px;line-height:62px;text-transform:capitalize;font-weight:700;margin-bottom:40px;position:relative}@media(max-width:1279px){.title-secondary[data-v-9e9da334]{font-size:38px;line-height:50px}}@media(max-width:599px){.title-secondary[data-v-9e9da334]{font-size:32px;line-height:42px}}.title-deco[data-v-9e9da334]{position:relative;display:inline-block}.title-deco h3[data-v-9e9da334]{overflow:hidden;color:#fff;padding:32px;display:flex;align-items:center;justify-content:center;text-align:center;position:relative;text-transform:capitalize;font-size:48px;font-Weight:var(--font-bold)}@media(min-width:960px){.title-deco h3[data-v-9e9da334]{border-radius:50%;width:300px;height:300px;background-color:var(--v-primary-base);background-attachment:fixed;background-repeat:no-repeat;background-size:contain}[dir=ltr] .title-deco h3[data-v-9e9da334]{background-position:0}[dir=rtl] .title-deco h3[data-v-9e9da334]{background-position:100%}.title-deco h3.bg-img[data-v-9e9da334]:before{content:\"\";width:100%;height:100%;background:#3b3b3b;opacity:.38;position:absolute;top:0;left:0}.title-deco h3 span[data-v-9e9da334]{position:relative}}@media(max-width:1279px){.title-deco h3[data-v-9e9da334]{font-size:38px;line-height:50px}}@media(max-width:959px){.title-deco h3[data-v-9e9da334]{padding-bottom:16px;background:none!important;width:auto;text-align:center}.theme--dark .title-deco h3[data-v-9e9da334]{color:var(--v-primarylight-base)}.theme--light .title-deco h3[data-v-9e9da334]{color:var(--v-primarydark-base)}}@media(max-width:599px){.title-deco h3[data-v-9e9da334]{font-size:32px;line-height:42px}}.title-deco[data-v-9e9da334]:before{content:\"\";width:400px;height:400px;top:-50px;left:-50px;border-radius:50%;border:1px solid;position:absolute}.theme--light .title-deco[data-v-9e9da334]:before{border-color:var(--v-primarylight-base)}.theme--dark .title-deco[data-v-9e9da334]:before{border-color:var(--v-primarydark-base)}@media(max-width:959px){.title-deco[data-v-9e9da334]:before{display:none}}@media(min-width:1280px){.title-icon-deco[data-v-9e9da334]{width:350px}}.title-icon-deco h3[data-v-9e9da334]{font-weight:700;text-transform:capitalize;width:200px;min-height:120px;font-size:48px;line-height:62px;position:relative}.theme--dark .title-icon-deco h3[data-v-9e9da334]{color:#fff}.theme--light .title-icon-deco h3[data-v-9e9da334]{color:var(--v-primarydark-base)}@media(max-width:1279px){.title-icon-deco h3[data-v-9e9da334]{font-size:38px;line-height:50px;width:100%;text-align:center}}@media(max-width:599px){.title-icon-deco h3[data-v-9e9da334]{font-size:32px;line-height:42px}}.title-icon-deco .icon[data-v-9e9da334]{position:relative;font-size:80px;color:transparent;-webkit-text-stroke:2px var(--v-primary-base);display:block;margin:144px 0 24px}[dir=ltr] .title-icon-deco .icon[data-v-9e9da334]{text-align:left}[dir=rtl] .title-icon-deco .icon[data-v-9e9da334]{text-align:right}@media(max-width:1279px){.title-icon-deco .icon[data-v-9e9da334]{display:none}}.title-icon-deco .capsul[data-v-9e9da334]{width:900px;height:500px;border-radius:500px;position:absolute;opacity:.75;top:80px}.theme--light .title-icon-deco .capsul[data-v-9e9da334]{background-image:linear-gradient(144deg,var(--v-primarylight-base),var(--v-secondarylight-base))}.theme--dark .title-icon-deco .capsul[data-v-9e9da334]{background-image:linear-gradient(144deg,var(--v-primarydark-base),var(--v-secondarydark-base))}[dir=ltr] .title-icon-deco .capsul[data-v-9e9da334]{right:-300px}[dir=rtl] .title-icon-deco .capsul[data-v-9e9da334]{left:-300px;transform:rotate(30deg)}[dir=ltr] .title-icon-deco .capsul[data-v-9e9da334]{transform:rotate(-30deg)}.title-icon-deco .circle[data-v-9e9da334]{width:700px;height:700px;top:50px;border-radius:50%;border:1px solid;position:absolute}[dir=ltr] .title-icon-deco .circle[data-v-9e9da334]{right:-40px}[dir=rtl] .title-icon-deco .circle[data-v-9e9da334]{left:-40px}.theme--light .title-icon-deco .circle[data-v-9e9da334]{border-color:var(--v-primarylight-base)}.theme--dark .title-icon-deco .circle[data-v-9e9da334]{border-color:var(--v-primarydark-base)}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_06e343fe_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(244);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_06e343fe_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_06e343fe_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_06e343fe_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_06e343fe_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".use-text-title[data-v-06e343fe]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-06e343fe]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-06e343fe]{font-size:28px;line-height:44px}}.use-text-title2[data-v-06e343fe]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-06e343fe]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-06e343fe]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-06e343fe]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-06e343fe]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-06e343fe]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-06e343fe]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-06e343fe]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-06e343fe]{font-size:16px;line-height:24px}}.use-text-caption[data-v-06e343fe],.use-text-paragraph[data-v-06e343fe]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-06e343fe]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-06e343fe]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-06e343fe]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-06e343fe]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-06e343fe]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-06e343fe]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-06e343fe]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-06e343fe]{display:none}}.main-wrap[data-v-06e343fe]{position:relative;width:100%;overflow:hidden}.theme--light .main-wrap[data-v-06e343fe]{color:rgba(0,0,0,.87)}.theme--dark .main-wrap[data-v-06e343fe]{color:#fff;background-color:#303030}.theme--light .main-wrap[data-v-06e343fe]{background-color:#fff}.space-top[data-v-06e343fe]{margin-top:160px}@media(max-width:1279px){.space-top[data-v-06e343fe]{margin-top:120px}}@media(max-width:599px){.space-top[data-v-06e343fe]{margin-top:80px}}.space-bottom-short[data-v-06e343fe]{margin-bottom:80px}.space-top-short[data-v-06e343fe]{margin-top:80px}@media(min-width:960px){.container-wrap[data-v-06e343fe]{margin-top:48px}}.container-wrap section[data-v-06e343fe]{position:relative}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=06e343fe&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"main-wrap\" data-v-06e343fe>","</div>",[_c('main-header'),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container-wrap\" data-v-06e343fe>","</div>",[_c('oval-top'),_vm._ssrNode(" "),_vm._ssrNode("<section id=\"home\" style=\"margin-left: 0;\" data-v-06e343fe>","</section>",[_c('video-banner')],1),_vm._ssrNode(" "),_vm._ssrNode("<section id=\"about\" class=\"space-top-short\" data-v-06e343fe>","</section>",[_c('about')],1),_vm._ssrNode(" "),_vm._ssrNode("<section id=\"ask-doctors\""+(_vm._ssrClass(null,[_vm.isMobile ? 'space-top-short' : 'space-top']))+" data-v-06e343fe>","</section>",[_c('ask-doctors')],1),_vm._ssrNode(" "),_vm._ssrNode("<section id=\"facility\""+(_vm._ssrClass(null,[_vm.isTablet ? 'space-top-short' : 'space-top']))+" style=\"background-color: #252B42;\" data-v-06e343fe>","</section>",[_c('expertise')],1)],2),_vm._ssrNode(" "),_c('main-footer'),_vm._ssrNode(" "),_c('hidden',{attrs:{"point":"mdDown"}},[_c('notification')],1)],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=06e343fe&scoped=true&

// EXTERNAL MODULE: ./components/Header/index.js + 58 modules
var Header = __webpack_require__(60);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/VideoBanner/VideoBanner.vue?vue&type=template&id=132ea39a&scoped=true&
var VideoBannervue_type_template_id_132ea39a_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"hero-content"},[_c('hidden',{attrs:{"point":"smUp"}},[_c('figure',{staticClass:"mobile-cover"},[_c('img',{attrs:{"src":_vm.cover,"alt":"cover"}})])]),_vm._ssrNode(" "),_c('v-container',{class:{ 'fixed-width': _vm.mdUp }},[_c('v-row',[(_vm.isTablet)?_c('v-col',{staticClass:"pa-6 visual-content",attrs:{"md":"6","cols":"12"}},[_c('div',{staticClass:"deco-banner"},[_c('div',{staticClass:"menu-bg"}),_vm._v(" "),_c('div',{staticClass:"video-bg"})]),_vm._v(" "),_c('img',{staticClass:"juntadir",attrs:{"src":_vm.juntasdir,"alt":""}}),_vm._v(" "),_c('div',{staticClass:"video-wrap"},[_c('div',{staticClass:"video-figure"},[_c('div',{staticClass:"inner-figure"})])]),_vm._v(" "),_c('div',{staticClass:"parallax-banner"},[_c('dots-parallax')],1)]):_vm._e()],1)],1),_vm._ssrNode(" "),_c('v-col',{attrs:{"cols":"12","md":"6"}},[_c('div',{staticClass:"banner-text"},[_c('div',{staticClass:"title"},[_c('h3',{staticClass:"text-helper use-text-title titleMovil"},[_vm._v("\n              Tu guía en "),_c('br'),_vm._v("cada trámite, "),_c('a',{staticStyle:{"color":"#2091F9"}},[_vm._v("Mejorando")]),_vm._v(" Tu "),_c('br'),_vm._v("Vida\n            ")])]),_vm._v(" "),_c('h5',{staticClass:"subtitle use-text-subtitle2"},[_vm._v("\n            Comprometidos con Tu Progreso\n\n          ")]),_vm._v(" "),_c('div',{staticClass:"consultas"},[_c('v-btn',{staticClass:"btnconsultas",staticStyle:{"background-color":"#252B42","color":"rgb(255, 255, 255)"},attrs:{"size":"small"}},[_vm._v("Consultas Gratis")])],1)])])],2)}
var VideoBannervue_type_template_id_132ea39a_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./components/VideoBanner/VideoBanner.vue?vue&type=template&id=132ea39a&scoped=true&
...
var VideoBanner_component = Object(componentNormalizer["a" /* default */])(
  ...
  VideoBannervue_type_template_id_132ea39a_scoped_true_render,
  VideoBannervue_type_template_id_132ea39a_scoped_true_staticRenderFns,
  false,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/AskDoctors/AskDoctors.vue?vue&type=template&id=9e9da334&scoped=true&
var AskDoctorsvue_type_template_id_9e9da334_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('fragment',[_c('div',{staticClass:"root"},[_c('div',{staticClass:"deco"}),_vm._v(" "),_c('v-container',{class:{ 'fixed-width': _vm.mdUp }},[_c('v-row',{staticClass:"spacing6",attrs:{"justify":"center"}},[_c('v-col',{staticClass:"pa-0",attrs:{"cols":"12","sm":"9","md":"2"}},[_c('div',{staticClass:"side-filter"},[_c('h4',{staticClass:"title-primary"},[_vm._v("\n              SERVICIOS\n\n            ")]),_vm._v(" "),_c('p',{staticClass:"subtitle"},[_vm._v("\n              De Inmigracion a Inversion\n            ")])])]),_vm._v(" "),_c('v-col',{staticClass:"pa-6 py-0",attrs:{"cols":"12","lg":"8","md":"10"}},[_c('div',{staticClass:"massonry"},[_c('v-row',_vm._l((_vm.doctorsData),function(item,index){return _c('v-col',{key:index,staticClass:"px-lg-8 px-3 py-3",attrs:{"cols":"12","sm":"6"}},[_c('div',[_c('profile-card',{attrs:{"avatar":item.avatar,"title":item.title,"description":item.description}})],1)])}),1),_vm._v(" "),_c('v-col',[_c('v-btn',{staticClass:"consulta",staticStyle:{"text-transform":"capitalize"},attrs:{"color":"primary"}},[_vm._v("\n                Consulta Gratis\n              ")])],1)],1)])],1)],1)],1)])}
var AskDoctorsvue_type_template_id_9e9da334_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./components/AskDoctors/AskDoctors.vue?vue&type=template&id=9e9da334&scoped=true&
...
var AskDoctors_component = Object(componentNormalizer["a" /* default */])(
  ...
  AskDoctorsvue_type_template_id_9e9da334_scoped_true_render,
  AskDoctorsvue_type_template_id_9e9da334_scoped_true_staticRenderFns,
  false,
